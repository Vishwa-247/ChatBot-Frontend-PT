...
//                 generateChatTitle(message.content, chat.model).then(
//                   (newTitle) => {
//                     setChats((prevChats) =>
//                       prevChats.map((c) =>
...
//                 apiService
//                   .saveMessage(chatId, message.role, message.content)
//                   .catch(console.error);
//               }
...
//           // Save to backend
//           apiService
//             .createChat(chatId, title, currentModel)
//             .catch(console.error);
//           if (message.role === "user" || message.role === "assistant") {
//             apiService
//               .saveMessage(chatId, message.role, message.content)
  ...
  useEffect(() => {
    const loadChats = async () => {
      try {
        ...
        if (
          lastChatId &&
          formattedChats.find((chat) => chat.id === lastChatId)
        ) {
